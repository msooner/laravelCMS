                    ...
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span><a
                                        href="{{url('admin/createAdmin')}}">新增</a>
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            @foreach($users as $v)
                                <tr>
                                    ...
                                    <td>{{$v->email}}</td>
                                    <td class="table-date am-hide-sm-only">{{$v->role}}</td>
                                    <td class="am-hide-sm-only">{{$v->phoneNum}}</td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span
                                                            class="am-icon-pencil-square-o"></span><a href="{{url('admin/edit.user/'.$v->id)}}">编辑</a>
                                                </button>
                                                <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only">
                                                    <span class="am-icon-trash-o"></span> <a href="{{url('admin/delete.user/'.$v->id)}}">删除</a>
                                                </button>
                                            </div>
                                        </div>
                                    </td>
