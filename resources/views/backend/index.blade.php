              ...
              <div class="widget big-stats-container">
                <div class="widget-content">
                  ...
                  <div id="big_stats" class="cf">
                    ...
                    <div class="stat"> <i class="icon-comment"></i> <span class="value" style="color: #f00;">20</span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-book"></i> <span class="value">22</span> </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <i class="icon-eye-open"></i> <span class="value">2588</span> </div>
                    <!-- .stat --> 
                  </div>
                </div>
                <!-- /widget-content --> 
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="{{ URL::asset('img/message_avatar1.png') }}"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="{{URL::asset('img/message_avatar2.png')}}"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="{{ URL::asset('img/message_avatar2.png') }}"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
